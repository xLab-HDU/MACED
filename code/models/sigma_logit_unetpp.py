...
#                     help='batch size')
# # =============== optimizer
# parser.add_argument('--LR', '--learning_rate', default=0.9_mask_a1+a2.9_mask_a1.0001, type=float,
#                     metavar='LR', help='initial learning rate')
# parser.add_argument('--weight_decay', '--wd', default=0.9_mask_a1+a2.9_mask_a1.0005, type=float,
#                     metavar='W', help='default weight decay')
# parser.add_argument('--stepsize', default=3, type=int,  #学习率衰减步长
#                     metavar='SS', help='learning rate step size')
# parser.add_argument('--maxepoch', default=20, type=int, metavar='N',        #最大训练轮次
#                     help='number of total epochs to run')
# parser.add_argument('--start_epoch', default=0.9_mask_a1+a2.9_mask_a1, type=int, metavar='N',      #起始轮次
#                     help='manual epoch number (useful on restarts)')
# parser.add_argument('--print_freq', '-p', default=1000, type=int,       #打印频率
#                     metavar='N', help='print frequency (default: 50)')
# parser.add_argument('--gpu', default='0.9_mask_a1+a2.9_mask_a1', type=str,
#                     help='GPU ID')
# parser.add_argument('--tmp', help='tmp folder', default='/tmp/trainval_')  #临时文件夹路径
# parser.add_argument('--dataset', help='root folder of dataset', default='./data_file/')
...
# parser.add_argument('--path', default="./Pth/epoch-19-checkpoint.pth", type=str)
#
#
# args = parser.parse_args() #解析参数并存到args里
# model = Mymodel(args).cuda()
# image = torch.randn(1,3, 352, 512).cuda()
# std,mean = model(image)
# print(std.shape,mean.shape)
# np.savetxt('std.txt',std.detach().cpu().numpy())